@php
    $punish = \App\Models\Logs\Punish::whereIn('Type', ['teamspeak', 'teamspeakNotice', 'teamspeakBan', 'teamspeakUnban'])->with(['user', 'admin'])->orderBy('Id', 'DESC')->paginate(request()->get('limit') ?? 25);
@endphp
