@php
    $punish = \App\Models\Logs\Punish::whereNotIn('Type', ['nickchange', 'teamspeak', 'teamspeakNotice', 'teamspeakBan', 'teamspeakUnban'])->with(['user', 'admin'])->orderBy('Id', 'DESC')->paginate(request()->get('limit') ?? 25);
@endphp
