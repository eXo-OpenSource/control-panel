...
<div class="row">
    <div class="col-12">
        <react-chart data-chart="money:faction:{{ $faction->Id }}:both" data-state="true" data-height="80vh" data-date="{{ Carbon\Carbon::now()->format('Y-m-d') }}" data-title="{{ __('Einnahmen/Ausgaben') }}"></react-chart>
    </div>
    <div class="col-6">
    </div>
</div>
